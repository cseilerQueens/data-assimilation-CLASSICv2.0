               ...
               seed = NULL) 
{
  ...
  for(iter in seq(start, maxiter, 1)) # cseiler: in case of interruption, continue with last iterration
    ...
    #  if(iter == 81) {print(Pop)} # cseiler Pop OK
    #  if(iter == 81) {print(Fitness)} # cseiler Fitness OK
    ...
    #  if(iter == 81) {print(Pop)} # cseiler Pop now differ
    #  if(iter == 81) {print(Fitness)} # cseiler Fitness now differ
        }
      else
...
ni <- readRDS("noInterruption_objectFinal.rds")
wi <- readRDS("objectFinal.rds")

 print(ni@solution)
 print(wi@solution)

print(ni@solution / wi@solution)
print(ni@fitnessValue / wi@fitnessValue)
print(ni@fitness/ wi@fitness)


# ni <- readRDS("ni_80.rds")
# wi <- readRDS("wi_80.rds")
# print(ni@fitness/ wi@fitness)
# print(ni@population/wi@population)


# ni <- readRDS("ni_81.rds")
# wi <- readRDS("wi_81.rds")
# print(ni@fitness/ wi@fitness)
# print(ni@population/wi@population)

# mv objectFinal.rds ni_seed1.rds
# mv objectFinal.rds wi_seed1.rds

ni <- readRDS("ni_seed1.rds")
wi <- readRDS("wi_seed1.rds")
print(ni@fitness/ wi@fitness)
print(ni@population/wi@population)
print(ni@solution/wi@solution)
