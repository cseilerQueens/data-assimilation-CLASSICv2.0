...
spatialCoverage=local # global # multipleGridCells
...
# xmlFile='/home/cseiler/CLASSICv2.0/classic/configurationFiles/outputVariableDescriptors_daisy.xml'
...
executableDir=$sourceCodeDir"/bin/CLASSIC_parallel_intel_decoupled"
